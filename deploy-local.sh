...
echo '0. stop old database/redis/L1 and docker run new database/redis/L1'
pm2 delete all
...
docker run -d -p 8545:8545 -p 7545:8545 --name zkbnb-contract srimannem/zkbnb:zkbnb-contract
