...
func (e *CreateCollectionExecutor) validateCategoryID() error {
	...
	switch e.txInfo.MetaData.CategoryID {
	case types.CollectArt:
		return nil
	case types.CollectScenery:
		return nil
	case types.CollectCartoon:
		return nil
	case types.CollectPhotography:
		return nil
	case types.CollectGames:
		return nil
	case types.CollectSports:
		return nil
	case types.CollectVirtualWorld:
		return nil
	case types.CollectMystery:
		return nil
	case types.CollectOthers:
		return nil
	default:
		return errors.New("CategoryID is error ")
	}
}
